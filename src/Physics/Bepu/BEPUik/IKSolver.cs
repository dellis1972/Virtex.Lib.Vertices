...
namespace BEPUik
{
    ...
    /// </para>
    /// <para>
    /// It's currently separated from the rest of vxVertices.Physics.BEPU library internals because the immediate goal is to test out 
    /// features to be potentially integrated into a blender content pipeline. vxVertices.Physics.BEPU interactions with this system
