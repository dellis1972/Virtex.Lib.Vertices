...
namespace Virtex.Lib.Vrtc.Core.Debug
{
    ...
    public class vxDebugCommandUI : DrawableGameComponent, IDebugCommandHost
    {
        ...
        public override void Update(GameTime gameTime)
        {
			...
			//Reset Line Count
			MaxLineDisplayCount = this.vxEngine.GraphicsDevice.Viewport.Height / (int)debugManager.DebugFont.MeasureString("A").Y - 3;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            */
			...
			for (int index = LineScrollPos; index < linestoshow; index++) {
				...
				spriteBatch.DrawString (font, linesarray [index], pos, consoleColour);
				pos.Y += font.LineSpacing;
			}
			...
			spriteBatch.Draw (vxEngine.Assets.Textures.Blank, 
				new Rectangle (0, (MaxLineDisplayCount+2) * (int)font.MeasureString ("A").Y, 2000, 4),
				Color.Black * 0.25f);

			spriteBatch.Draw (vxEngine.Assets.Textures.Blank, 
				new Rectangle (0, (MaxLineDisplayCount+2) * (int)font.MeasureString ("A").Y, 2000, 3),
				Color.Black * 0.6f);

			spriteBatch.Draw (vxEngine.Assets.Textures.Blank, 
				new Rectangle (0, (MaxLineDisplayCount+2) * (int)font.MeasureString ("A").Y, 2000, 2),
				Color.Black);
			
			spriteBatch.Draw (vxEngine.Assets.Textures.Blank, 
				new Rectangle (0, (MaxLineDisplayCount+2) * (int)font.MeasureString ("A").Y, 2000, 1),
				Color.White*0.75f);
			...
			int scrnHeight = (int)font.LineSpacing * (MaxLineDisplayCount+2);//debugManager.GraphicsDevice.Viewport.Height;
			...
			int py = 5;
			rect = new Rectangle (
				debugManager.GraphicsDevice.Viewport.Width - 2 * px,
				py + barPos,
				3,
				barHeight - 2 * py);
