...
namespace Virtex.Lib.Vrtc.Graphics
{
    public class vxDepthOfFieldPostProcess : vxPostProcessor
    {
        ...
        public vxDepthOfFieldPostProcess(vxEngine Engine) :base(Engine, Engine.Assets.PostProcessShaders.DepthOfFieldEffect)
        {
        ...
        public override void Apply()
        {
            ...
            if (Engine.Profile.Settings.Graphics.DepthOfField != vxEnumQuality.None)
            {
