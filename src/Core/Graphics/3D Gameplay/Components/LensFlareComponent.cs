...
#region Fields
        ...
        Flare[] flares =
        {
            new Flare(-0.5f, 0.7f, new Color( 50,  25,  50), "Graphics/Flares/flare1"),
            new Flare( 0.3f, 0.4f, new Color(100, 255, 200), "Graphics/Flares/flare1"),
            new Flare( 1.2f, 1.0f, new Color(100,  50,  50), "Graphics/Flares/flare1"),
            new Flare( 1.5f, 1.5f, new Color( 50, 100,  50), "Graphics/Flares/flare1"),

            new Flare(-0.3f, 0.7f, new Color(200,  50,  50), "Graphics/Flares/flare2"),
            new Flare( 0.6f, 0.9f, new Color( 50, 100,  50), "Graphics/Flares/flare2"),
            new Flare( 0.7f, 0.4f, new Color( 50, 200, 200), "Graphics/Flares/flare2"),

            new Flare(-0.7f, 0.7f, new Color( 50, 100,  25), "Graphics/Flares/flare3"),
            new Flare( 0.0f, 0.6f, new Color( 25,  25,  25), "Graphics/Flares/flare3"),
            new Flare( 2.0f, 1.4f, new Color( 25,  50, 100), "Graphics/Flares/flare3"),
        };
...
#region Initialization
        ...
        /// </summary>
        public LensFlareComponent(vxEngine vxEngine)
        {
        ...
        public void LoadContent()
        {
            ...
            glowSprite = vxEngine.EngineContentManager.Load<Texture2D>("Graphics/Flares/glow");
            
            foreach (Flare flare in flares)
            {
                flare.Texture = vxEngine.EngineContentManager.Load<Texture2D>(flare.TextureName);
            }

            // Effect for drawing occlusion query polygons.
            basicEffect = new BasicEffect(vxEngine.GraphicsDevice);
            ...
            occlusionQuery = new OcclusionQuery(vxEngine.GraphicsDevice);
        }
...
#region Draw
        ...
        public void UpdateOcclusion()
        {
            ...
            vxEngine.GraphicsDevice.BlendState = ColorWriteDisable;
            vxEngine.GraphicsDevice.DepthStencilState = DepthStencilState.DepthRead;
            ...
            vxEngine.GraphicsDevice.DrawUserPrimitives(PrimitiveType.TriangleStrip, queryVertices, 0, 2);
