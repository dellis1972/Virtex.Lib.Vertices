...
{
	/// <summary>
	/// Toolbar control that holds <see cref="Virtex.Lib.Vrtc.GUI.Controls.vxToolbarButton"/> 
	/// </summary>
    public class vxToolbar : vxGUIBaseItem
    {
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Virtex.Lib.Vrtc.GUI.Controls.vxToolbar"/> class.
		/// </summary>
