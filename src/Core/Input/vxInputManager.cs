...
namespace Virtex.Lib.Vrtc.Core.Input
{
	...
	public class KeyBindings
	{
		...
		public Dictionary<object, KeyBinding> Bindings = new Dictionary<object, KeyBinding>();

		/// <summary>
		/// Initializes a new instance of the <see cref="T:Virtex.Lib.Vrtc.Core.Input.KeyBindings"/> class with the 
		/// default QWERTY Keyboard Bindings.
		/// </summary>
		public KeyBindings(vxEngine Engine)
		{
			Add(vxKeyBindingID.Forward, new KeyBinding("Forward", Keys.W));
			Add(vxKeyBindingID.Back, new KeyBinding("Back", Keys.S));
			Add(vxKeyBindingID.Left, new KeyBinding("Left", Keys.A));
			Add(vxKeyBindingID.Right, new KeyBinding("Right", Keys.D));

			Add(vxKeyBindingID.Jump, new KeyBinding("Jump", Keys.Space));
			Add(vxKeyBindingID.Croutch, new KeyBinding("Croutch", Keys.LeftControl));

			Add(vxKeyBindingID.Interact1, new KeyBinding("Interact1", Keys.Q));
			Add(vxKeyBindingID.Interact2, new KeyBinding("Interact2", Keys.E));
		}
		...
		public void Add(object id, KeyBinding NewKeyBinding)
		{
		...
		public KeyBinding GetBinding(object id)
		{
			return Bindings[id];
		}
	}
	...
	public class vxInputManager
	{
		...
		/// </summary>
		public vxInputManager(vxEngine engine)
		{
			KeyBindings = new KeyBindings(engine);
